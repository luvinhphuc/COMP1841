/** Manages the responsive navigation overlay, focus state, and menu animations. */
import { closeAllDropdowns } from './dropdown-menu.js';
...
(() => {
    ...
    const setMenuOpen = (isOpen) => {
        ...
        if (isOpen) {
            closeAllDropdowns();
            setActiveMenu(initialMenuKey, false, initialMenuKey !== 'home');
