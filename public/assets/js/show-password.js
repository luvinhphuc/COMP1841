/** Adds accessible visibility toggles to password fields rendered on the current page. */
(() => {
    ...
    passwordFields.forEach((field) => {
        ...
        toggle.type = 'button';
        toggle.className =
            'absolute inset-y-1 right-1 flex w-9 items-center justify-center rounded-lg text-ui-muted transition hover:bg-ui-canvas hover:text-ui-ink';
